...
void World::loadTextures()
{
	...
	mTextures.load(Textures::Jungle, "Media/Textures/Jungle.jpg");
...
void World::buildScene()
{
	...
	jungleSprite->setPosition(mWorldBounds.left, mWorldBounds.top - 400);
...
{
	int maxEnemies = 50000;
	for (int i = 0; i < maxEnemies; i++) {
		// Add enemies to the spawn point container
		addEnemy(Aircraft::Raptor, 0.f, 300.f);
		addEnemy(Aircraft::Raptor, 50.f, 300.f);
		addEnemy(Aircraft::Raptor, -50.f, 300.f);
		addEnemy(Aircraft::Raptor, +100.f, 300.f);
		addEnemy(Aircraft::Raptor, -100.f, 300.f);
		addEnemy(Aircraft::Raptor, +200.f, 300.f);
		addEnemy(Aircraft::Raptor, -200.f, 300.f);
		addEnemy(Aircraft::Raptor, +300.f, 300.f);
		addEnemy(Aircraft::Raptor, -300.f, 300.f);
	}	
...
{
	enemyCount = mActiveEnemies.size();
	// Spawn all enemies entering the view area (including distance) this frame
	while (!mEnemySpawnPoints.empty() && enemyCount <= 5)
	{
